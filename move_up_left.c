...
static void		ft_rmoffset_line(char tab[4][4], int offset)
{
	int i;
	int j;
...
static void		ft_rmoffset_col(char tab[4][4], int offset)
{
	int i;
	int j;
...
static int		ft_get_offset_line(char tab[4][4])
{
	int i;
	int j;
...
static int		ft_get_offset_col(char tab[4][4])
{
	int i;
	int j;
